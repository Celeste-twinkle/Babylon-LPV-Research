import"./style-CVgRVYuf.js";import{S as e,o as t}from"./irradianceBakeBundle-DOhIGlvg.js";import{i as n}from"./pbrMaterial-Cea-hY1L.js";import{a as r,i,n as a,o,r as s,s as c,t as l}from"./directPreviewRuntime-rVp1VAsZ.js";var u=`assets/sponza-irradiance-bake.ivpack`,d={speed:.62,distance:1,intensity:1,displayExposureEv:0,specularEnabled:!0,dominantSpecular:!1,normalBias:.3},f=location.pathname.toLowerCase().includes(`webgpu`)?`webgpu`:`webgl`,p=f===`webgpu`?`WebGPU`:`WebGL`;n.ForceGLSL=!0,e.ForceGLSL=!0,document.querySelector(`#app`).innerHTML=`
  <div class="app-shell">
    <header class="topbar">
      <a class="brand" href="./">
    ...
    <main class="workspace">
      ...
      <aside class="research-panel" aria-label="Direct preview controls">
        ...
        <section class="control-grid" aria-label="Preview settings">
          ...
          <label>
            Display exposure EV
            <input id="displayExposureEv" type="number" min="-4" max="4" step="0.25" value="${d.displayExposureEv}" />
          </label>
          <label>
            Normal bias
            <input id="normalBias" type="number" min="-0.5" max="0.5" step="0.001" value="${d.normalBias}" />
          </label>
          <label class="checkbox-label">
            <input id="specularEnabled" type="checkbox" ${d.specularEnabled?`checked`:``} />
            Volume speculars
          </label>
          <label class="checkbox-label">
            <input id="dominantSpecular" type="checkbox" ${d.dominantSpecular?`checked`:``} />
