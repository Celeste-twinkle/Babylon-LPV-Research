...
`;e.ShadersStore[Q]||(e.ShadersStore[Q]=$);var Qe=[re,i,Se,ce,p,pe,me,De,he,Ae,fe,ae,ve,a,g,se,t,ge,te,ie,_e,u,Me,ke,n,ue,Ee,r,c,Pe,Te,Oe,je,o,Ie,Le,ye,s,Re,ze,be,Ce,Be,ee,Fe,k,Ve,He,we,xe,Ue,We,Ge,Ke,le,qe,Je,Ye,Xe,oe,ne,Ne,Ze,de,l];for(let t of Qe)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);var $e={name:Q,shader:$};export{$e as openpbrPixelShader};