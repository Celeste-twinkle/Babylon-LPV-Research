import"./style-CVgRVYuf.js";import{S as e,o as t}from"./irradianceBakeBundle-DOhIGlvg.js";import{i as n}from"./pbrMaterial-Cea-hY1L.js";import{a as r,i,n as a,o,r as s,s as c,t as l}from"./directPreviewRuntime-6xTxtbSk.js";var u=`assets/sponza-irradiance-bake.ivpack`,d={speed:.62,distance:1,intensity:1,displayExposureEv:0,specularEnabled:!0,dominantSpecular:!1,normalBias:.3},f=location.pathname.toLowerCase().includes(`webgpu`)?`webgpu`:`webgl`,p=f===`webgpu`?`WebGPU`:`WebGL`;n.ForceGLSL=!0,e.ForceGLSL=!0,document.querySelector(`#app`).innerHTML=`
  <div class="app-shell">
    <header class="topbar">
      <a class="brand" href="./">
