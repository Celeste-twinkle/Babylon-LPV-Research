...
}`;e.ShadersStoreWGSL[V]||(e.ShadersStoreWGSL[V]=H);var U=[f,p,P,y,m,g,M,o,i,d,D,x,N,L,t,l,v,O,A,h,T,C,k,j,n,a,r,_,b,w,B,s,c,S,u,E];for(let t of U)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var W={name:V,shader:H};export{W as openpbrVertexShaderWGSL};