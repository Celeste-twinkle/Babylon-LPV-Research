...
`;e.ShadersStore[G]||(e.ShadersStore[G]=K);var q=[F,y,R,f,p,P,D,m,g,M,o,i,d,x,v,N,V,t,l,T,C,O,A,h,k,j,n,a,r,_,b,w,W,s,c,S,u,E];for(let t of q)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);var J={name:G,shader:K};export{J as openpbrVertexShader};