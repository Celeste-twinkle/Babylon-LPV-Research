...
}`;e.ShadersStoreWGSL[V]||(e.ShadersStoreWGSL[V]=H);var U=[p,m,P,D,h,_,M,o,i,d,x,y,N,L,t,l,f,O,A,g,T,C,k,j,n,a,r,v,b,w,B,s,c,S,u,E];for(let t of U)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var W={name:V,shader:H};export{W as openpbrVertexShaderWGSL};